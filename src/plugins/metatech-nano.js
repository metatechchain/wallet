// Basic functions for communication with metatech nano ledger hw, using metatech-ledgerjs

import MetaTechNano from 'metatech-ledgerjs/src/metatech-nano.js';
...
export class FNano {
    ...
    async getVersion() {
        ...
        if (transport) {
            ...
            const bridge = new MetaTechNano(transport);
