                            ...
                            <span class="address-col">
                                ...
                                <f-copy-button :text="account.address" tooltip="Copy address to clipboard"
                                    ...
                                    <template #popover-text>
                                        ...
                                        Warning: Use this address to receive MetaTech MTC only. If you are receiving
...
export default {
    ...
    components: { MTCTokenValue, FCopyButton, AccountName, AccountSettingsWindow, FCard },
