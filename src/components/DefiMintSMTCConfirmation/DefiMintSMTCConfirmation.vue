<template>
    <div class="defi-mint-smtc-confirmation">
        <tx-confirmation
            v-if="hasCorrectParams"
            :tx="tx"
            send-button-label="Submit"
            password-label="Please enter your wallet password to mint sMTC"
        ...
        >
            <h2 class="not-visible" data-focus>Mint sMTC - Confirmation</h2>
...
export default {
    ...
    methods: {
        async setTx() {
            ...
            this.dAmountDelegated = this.$fWallet.WEIToMTC(this.d_amountDelegated);
        ...
        onSendTransactionSuccess(_data) {
            if (!this.isView) {
                this.$emit('change-component', {
                    to: 'staking-mint-smtc-confirmation-success-message',
                    from: this.compName,
                    data: {
                ...
                this.$router.replace({
                    name: `defi-mint-smtc-transaction-success-message`,
                    params,
                });
            }
        },
        ...
        onChangeComponent(_data) {
            let transactionRejectComp = `defi-mint-smtc-transaction-reject-message`;
