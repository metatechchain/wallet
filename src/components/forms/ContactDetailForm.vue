<template>
    <div class="contact-detail-form">
                        ...
                        <div class="break-word">
                            ...
                            >
                                <template #popover-text>
                                    ...
                                    Warning: Use this address to receive MetaTech MTC only. If you are receiving MTC-ERC20
        ...
        <q-r-code-window ref="qrWindow" :address="contactData.address">
            <f-message v-show="blockchain === 'metatech'" type="warning" with-icon>
                Warning: Use this address to receive MetaTech MTC only. If you are receiving MTC-ERC20 you need to use a
                different address!
            </f-message>
        </q-r-code-window>
    </div>
...
export default {
    ...
    mounted() {
        ...
        this.blockchain = this.contactData.blockchain || 'metatech';
    },
    ...
    methods: {
        ...
        async checkAddress(_value) {
            ...
            let address = _value;
            if (blockchain === 'metatech' && resolution.isSupportedDomainInNetwork(_value)) {
                try {
                    this.resolvedAddress = address = await resolution.multiChainAddr(_value, 'MTC', 'METATECH');
                } catch (e) {
            ...
            if (!this.$fWallet.isValidAddress(address, blockchain)) {
                if (blockchain === 'metatech') {
                    this.addressErrorMsg = 'Not valid metatech address';
            ...
            if (
                ...
                (blockchain === 'metatech' && this.getAccountAndIndexByAddress(address).index !== -1)
            ) {
