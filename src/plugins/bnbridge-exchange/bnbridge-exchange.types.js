 ...
 * @property {boolean} mtc_enabled
 * @property {boolean} listed
 * @property {boolean} listing_proposed
 * @property {boolean} metatech_enabled
 ...
 * @typedef {('MetaTechToBinance' | 'EthereumToBinance' | 'MetaTechToEthereum' | 'BinanceToMetaTech' | 'BinanceToEthereum' | 'EthereumToMetaTech')} BNBridgeDirection
 */
