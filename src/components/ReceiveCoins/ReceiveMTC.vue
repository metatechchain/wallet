<template>
    <div class="receive-mtc">
        <div class="align-center">
            Send your MetaTech MTC to:
            ...
            <h3 class="address break-word" :class="addressCssClass">
                ...
                >
                    <template #popover-text>
                        ...
                        Warning: Use this address to receive MetaTech MTC only. If you are receiving MTC-ERC20 you need to
        ...
        >
            ...
            <div class="align-center">
                <img src="img/nano-s-verify-address.png" alt="metatech nano device" /><br /><br />
            </div>
...
import { U2FStatus } from '../../plugins/metatech-nano.js';
