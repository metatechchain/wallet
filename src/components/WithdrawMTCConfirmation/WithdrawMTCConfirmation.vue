<template>
    <div class="withdraw-mtc-confirmation">
        <tx-confirmation
            :tx="tx"
            confirmation-comp-name="withdraw-mtc-confirmation"
...
export default {
    name: 'WithdrawMTCConfirmation',

    components: { MTCTokenValue, LedgerConfirmationContent, TxConfirmation },

    props: {
        /** `accountInfo` object from `UnstakeMTC` component. */
        accountInfo: {
            type: Object,
            default() {
                return {};
    ...
    methods: {
        ...
        onSendTransactionSuccess(_data) {
            this.$emit('change-component', {
                to: 'staking-withdraw-mtc-confirmation-success-message',
                from: 'withdraw-mtc-confirmation',
                data: {
