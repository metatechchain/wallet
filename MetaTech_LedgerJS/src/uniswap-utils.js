...
/**
 * uniswapAddLiquidityMTC creates a contract call transaction to add liquidity
 ...
 * @param {string|{BN}} amountMTCDesired
 * @param {string|{BN}} amountTokenMin
 * @param {string|{BN}} amountMTCMin
 * @param {string} to
 * @param {string|{BN}} deadline
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapAddLiquidityMTC(
    web3,
    routerAddress,
    token,
    amountTokenDesired,
    ...
    return {
        to: routerAddress,
        value: web3Utils.numberToHex(amountMTCDesired),
        data: web3.eth.abi.encodeFunctionCall({
            "constant": false,
            "inputs": [
                {
            ...
            "type": "function"
        }, [token, amountTokenDesired, amountTokenMin, amountMTCMin, to, deadline])
    };
}
...
/**
 * uniswapRemoveLiquidityMTC creates a contract call transaction to remove liquidity
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapRemoveLiquidityMTC(
    web3,
    routerAddress,
    token,
    liquidity,
    ...
    return {
        ...
        data: web3.eth.abi.encodeFunctionCall({
            ...
            "stateMutability": "nonpayable",
            "type": "function"
        }, [token, liquidity, amountTokenMin, amountMTCMin, to, deadline])
    };
}
...
/**
 * uniswapExactMTCForTokens creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapExactMTCForTokens(
    web3,
    routerAddress,
    amountIn,
    amountOutMin,
...
/**
 * uniswapMTCForExactTokens creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapMTCForExactTokens(
    web3,
    routerAddress,
    amountOut,
    amountInMax,
...
/**
 * uniswapTokensForExactMTC creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapTokensForExactMTC(
    web3,
    routerAddress,
    amountOut,
    amountInMax,
...
/**
 * uniswapExactTokensForMTC creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapExactTokensForMTC(
    web3,
    routerAddress,
    amountIn,
    amountOutMin,
...
export default {
    ...
    /*********** liquidity ***********/
    uniswapAddLiquidity,
    uniswapAddLiquidityMTC,
    uniswapRemoveLiquidity,
    uniswapRemoveLiquidityMTC,
    uniswapApproveShareTransfer,

    /*********** SWAP calls **********/
    uniswapExactTokensForTokens,
    uniswapExactMTCForTokens,
    uniswapTokensForExactTokens,
    uniswapMTCForExactTokens,
    uniswapTokensForExactMTC,
    uniswapExactTokensForMTC,
};
