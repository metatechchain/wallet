<template>
    <div class="tx-confirmation">
        ...
        >
            ...
            <div class="align-center"><img src="img/nano-s-confirm-tx.png" alt="metatech nano device" /><br /><br /></div>
        ...
        >
            <div class="align-center">
                ...
                <div v-else-if="!$mm.isCorrectChainId()">
                    Please, select MetaTech chain in Metamask.
                </div>
        ...
        async onFFormSubmit(_event) {
            ...
            if (currentAccount && this.tx && fWallet.isValidAddress(this.tx.to)) {
                ...
                if (data.gasLimit && data.gasPrice) {
                    this.$store.commit(
                        SET_TX_FEE,
                        fWallet.WEIToMTC(fWallet.getTransactionFee(data.gasPrice, data.gasLimit))
                    );
                } else {
