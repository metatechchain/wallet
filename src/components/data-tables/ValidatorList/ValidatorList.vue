                    ...
                    <div v-if="column" class="row no-collapse no-vert-col-padding">
                        ...
                        <div class="col break-word">
                            <div class="inline-img validator-img">
                                ...
                                <img v-else src="img/metatech-logo.png" alt="metatech logo" class="not-fluid" />
                            </div>
                        </div>
                    </div>
                    <template v-else>
            ...
            async result(_data, _key) {
                ...
                if (_key === 'stakers') {
                    ...
                    data.forEach((_item, _idx) => {
                        // _item.total_staked = WEIToMTC(_item.stake) + WEIToMTC(_item.delegatedMe);
                        totals.selfStaked += parseFloat(numToFixed(WEIToMTC(_item.stake), 0));
                        totals.totalDelegated += parseFloat(numToFixed(WEIToMTC(_item.delegatedMe), 0));
                        totals.totalStaked += parseFloat(numToFixed(WEIToMTC(_item.totalStake), 0));
                ...
                */
                {
                    ...
                    formatter: (_value) => formatNumberByLocale(WEIToMTC(_value), 0),
                    sortFunc: sortByHex,
                    cssClass: 'align-end',
                },
                {
