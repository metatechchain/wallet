...
// MAX_MTC_TRANSFER_STR represents maximum amount of MTC tokens (in WEI units) transferable by a transaction.
const MAX_MTC_TRANSFER_STR = ["2", "284", "136", "835", "000000000000000000"].join("");
