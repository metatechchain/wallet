                    ...
                    <div class="col break-word">
                        <template v-if="canClaimRewards(item.rewards)">
                            <f-token-value
                                ...
                                :use-placeholder="false"
                                :token="wmtcToken"
                                :value="pendingRewardsWMTC(item.rewards) - stashedRewardsWMTC(item.rewards)"
                            />
                            <span class="currency-light">
                                ...
                                <f-token-value
                                    :use-placeholder="false"
                                    :token="wmtcToken"
                                    :value="stashedRewardsWMTC(item.rewards)"
                                />
                            </span>
                        </template>
                ...
                <div v-if="column" class="row no-collapse no-vert-col-padding">
                    ...
                    <div class="col break-word">
                        <template v-if="usedAsCollateral(item)">
                            ...
                            <template v-if="item.symbol === 'WMTC'">
                                ,
                        ...
                        <!--                        <template v-if="canClaimRewards(item.rewards)">
                            ,<a
                                ...
                                href="#"
                                :data-pending-rewards="pendingRewardsWMTC(item.rewards)"
...
import { MAX_TOKEN_DECIMALS_IN_TABLES } from '@/plugins/metatech-web3-wallet.js';
...
export default {
    ...
    methods: {
        ...
        async addRows(_account) {
            ...
            this.wmtcToken = tokens.find((_item) => _item.symbol === 'WMTC');
            ...
            const items = tokens.filter((_item) => {
                ...
                if ((collateral !== 0 || debt !== 0) && _item.symbol !== 'WMTC' && _item.symbol !== 'SMTC') {
        ...
        usedAsCollateral(_token) {
            return _token.symbol === 'WMTC' || _token.symbol === 'SMTC';
        },
         ...
         * @param {object} _rewards
         */
        pendingRewardsWMTC(_rewards) {
            return this.$defi.fromTokenValue(_rewards.rewardsEarned, this.wmtcToken) || 0;
        },

        /**
         * @param {object} _rewards
         */
        stashedRewardsWMTC(_rewards) {
            return this.$defi.fromTokenValue(_rewards.rewardsStashed, this.wmtcToken) || 0;
        },
