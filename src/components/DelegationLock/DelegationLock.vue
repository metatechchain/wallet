...
export default {
    ...
    methods: {
        async init() {
            ...
            this.amountDelegated = parseFloat(this.$fWallet.WEIToMTC(this.delegation.amountDelegated));
        ...
        checkAmount(_value) {
            ...
            if (!isNaN(value)) {
                if (value <= amountDelegated && value >= 1) {
                    ...
                    this.amountErrMsg = `You can't lock amount less than 1 MTC`;
                } else if (value >= 1) {
                    this.amountErrMsg = `You can lock max ${amountDelegated} MTC`;
                }
            }
