...
const METATECH_CHAIN_ID = appConfig.chainId;

/** @type {MMChain} */
export const METATECH_MAINNET = {
    chainId: appConfig.mainnet.chainId,
    chainName: 'Meta Tech Mainnet',
    nativeCurrency: {
        name: 'Meta Tech',
        symbol: 'MTC',
        decimals: 18,
...
export class MM {
     ...
     */
    isCorrectChainId() {
        return this._provider && this._provider.chainId === METATECH_CHAIN_ID;
    }
