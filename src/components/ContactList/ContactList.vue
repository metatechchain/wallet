                                ...
                                <span class="address-col">
                                    ...
                                    >
                                        <template #popover-text>
                                            ...
                                            <template v-if="contact.blockchain === 'metatech'">
                                                <br />
                                                Warning: Use this address to receive MetaTech MTC only. If you are
    ...
    props: {
        ...
        filterByBlockchain: {
            ...
            validator: function (_value) {
                return !_value || ['metatech', 'ethereum', 'binance'].indexOf(_value) !== -1;
            },
        },
    },
