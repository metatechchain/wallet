...
export default {
    ...
    computed: {
        undelegateMax() {
            return this.accountInfo ? WEIToMTC(this.accountInfo.delegation.amountDelegated) : 0;
            /*
            return this.accountInfo
                ? WEIToMTC(this.accountInfo.delegation.amount) - this.accountInfo.withdrawRequestsAmount
                : 0;
*/
        },
