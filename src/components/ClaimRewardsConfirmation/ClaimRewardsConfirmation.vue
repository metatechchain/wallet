...
export default {
    ...
    components: { MTCTokenValue, FMessage, FPlaceholder, LedgerConfirmationContent, TxConfirmation },
    ...
    methods: {
        delegatedLimitReached() {
            ...
            this.delegatedLimit = parseFloat(this.$fWallet.WEIToMTC(delegatedLimit)).toFixed(2);
